...
def print_usage():
    print(
        ...
        "\n"
        "   examples:\n"
        "       python3 match_simulator.py --submissions 4:example_submissions/complex.py --engine\n"
        "       python3 match_simulator.py --submissions 1:example_submissions/complex.py 3:my_submission.py --engine\n"
        "       python3 match_simulator.py --submissions 3:example_submissions/complex.py d:my_submission.py --engine\n"
    )
    sys.exit(0)
